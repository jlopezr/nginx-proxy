...
In the case of noredirect method, you can provide a custom per-virtual-host configuration for the non-SSL site. 
This allows to serve different content in SSL and non-SSL modes.
